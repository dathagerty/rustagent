...
- [x] Better interaction model - TUI
- [x] Async channel integration with PlanningAgent
- [x] Async channel integration with RalphLoop
- [x] Spinner animation
- [x] Help overlay
- [x] Keyboard navigation in Kanban
- [x] Thinking indication when running - no idea what model is doing
- [x] Respond better to 429 requests
